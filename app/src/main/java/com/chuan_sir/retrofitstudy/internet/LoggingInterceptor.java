...
public class LoggingInterceptor implements Interceptor {
    ...
    public Response intercept(Chain chain) throws IOException {
        ...
        Log.i("LoggingInterceptor", String.format("发送请求 %s on %s%n%s", request.url(), chain.connection(), request.headers()));
        ...
        Log.i("LoggingInterceptor", String.format("接收响应：[%s] %n返回json:%s  %.1fms%n%s",
